const CACHE_NAME = 'smash-signup-v9'; // Increment version on each deployment

// Install event - activate immediately
self.addEventListener('install', (event) => {
  console.log('Service Worker: Installing v9 with network-first strategy');
...
self.addEventListener('activate', (event) => {
  ...
  event.waitUntil(
    caches.keys().then((cacheNames) => {
      ...
      console.log('Service Worker: Activated v9, taking control of all pages');
